...
class Tracker:
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        tracks = {
            "players": [], # at frame index -> {tracker id:{bbox:bbox}, ... , ...}
            "referees": [], # at frame index -> {tracker id:{bbox:bbox}, ... , ...}
            "ball": [] # at frame index -> 1:{bbox:bbox}
        }
    ...
    def draw_annotations(self, video_frames, tracks, ball_possession):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            frame = self.draw_team_ball_possession(frame, frame_num, ball_possession)

            output_video_frames.append(frame)

        return output_video_frames
            
    def draw_team_ball_possession(self, frame, frame_num, ball_possession):
